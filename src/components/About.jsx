    ...
    <section id="about" className="relative w-full py-20 bg-gradient-to-b from-slate-950 to-slate-900 text-white">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <SectionCard title={<span className="inline-flex items-center gap-2"><BookOpen className="h-5 w-5 text-emerald-400" /> Education</span>}>
          ...
          <SectionCard title={<span className="inline-flex items-center gap-2"><Award className="h-5 w-5 text-emerald-400" /> Experience</span>}>
          ...
          <SectionCard title={<span className="inline-flex items-center gap-2"><Code className="h-5 w-5 text-emerald-400" /> Skills</span>}>
